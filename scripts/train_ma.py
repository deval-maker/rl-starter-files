...
acmodel = ACModelMA(obs_space, envs[0].action_space, envs[0].n_agents, envs[0].world.encode_dim,
                    args.mem, args.text)
...
if args.algo == "a2c":
    ...
    algo = torch_ac.PPOAlgoMA(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                            args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
...
while num_frames < args.frames:
    ...
    if rreturn_per_episode["mean"] > prev_ret:
